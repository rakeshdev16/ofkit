        ...
        <div class="topbar d-flex align-items-center">
            <nav class="navbar navbar-expand gap-3">
                <div class="topbar-logo-header d-none d-lg-flex">
                    <div class="">
                        <img src="assets/images/3.png" class="" width="100px" alt="logo icon">
                    </div>
                </div>
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <li>
                            <form action="{{ route('logout') }}" method="POST">
                                @csrf
                                <button type="submit" class="dropdown-item d-flex align-items-center"><i class="bx bx-log-out-circle"></i><span>Logout</span></button>
                            </form>
                        </li>
                    </ul>
                </div>
            ...
            <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar"
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav align-items-center flex-grow-1">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="{{ route('children.index') }}">
                                <div class="parent-icon"><i class='fadeIn animated bx bx-user-circle'></i>
                                </div>
                                <div class="menu-title d-flex align-items-center">Children</div>
                            </a>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="#">
                                ...
                                <div class="menu-title d-flex align-items-center">Staff</div>
                            </a>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="#">
                                <div class="parent-icon"><i class='fadeIn animated bx bx-calendar-exclamation'></i>
                                </div>
                                <div class="menu-title d-flex align-items-center">Therapy Schedule</div>
                            </a>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="#">
                                ...
                                <div class="menu-title d-flex align-items-center">Clusters</div>
                            </a>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="#">
                                ...
                                <div class="menu-title d-flex align-items-center">Kindergarten</div>
                            </a>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="#">
                                <div class="parent-icon"><i class='fadeIn animated bx bx-table'></i>
                                </div>
