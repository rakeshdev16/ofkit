            ...
            <div class="page-wrapper">
                <div class="page-content">
                    <div class="page-breadcrumb d-flex align-items-center mb-3">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0 p-0">
                                    <li class="breadcrumb-item">
                                        <a href="{{ route('children-table.index') }}?type=file-type">
                        ...
                        <div class="ms-auto">
                            <div class="">
                                <button data-url="{{ route('children-table.index') }}?type=file-type" class="btn button exit">{{ __('comon.back') }}</button>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xl-6 mx-auto">
                            <div class="card">
                                <div class="card-body p-4">
                                    <h5 class="mb-4">{{ __('tables.addFileTypeDetail') }}</h5>
                                    <form class="row g-3" action="{{ route('children-table.store') }}" method="POST">
                                        @csrf
                                        <div class="col-md-12">
                                            @include('components.text-input', ['label' => __('tables.fileType'), 'name' => 'name', 'icon' => 'user'])
                                        </div>
                                        <div class="col-md-12">
