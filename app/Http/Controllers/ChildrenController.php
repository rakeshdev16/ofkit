...
class ChildrenController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'dob' => 'Please chose date of birth',
            'address' => 'Please enter address',
            'functionality_id' => 'Please chose functionality',
            'diagnosis_id' => 'Please chose diganosis',
            'status_id' => 'Please chose status',
            'service_start_date' => 'Please chose date',
            'hmo_id' => 'Please chose hmo',
            ...
            'family_status' => "Please chose family status",
            ...
            'food_allergie' => "Please chose food allergie",
