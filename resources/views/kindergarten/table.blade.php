<table id="staffTable" class="table table-style table-bordered" style="width:100%">
    <thead>
        <tr>
            ...
            @include('components.table-heading', ['label' => __('kindergarten.clusterTh'), 'key' => 'cluster_id', 'width' => '9.4%'])
            @include('components.table-heading', ['label' => __('kindergarten.clusterManagerTh'), 'key' => 'cluster_manager_id', 'width' => '9.4%'])
            @include('components.table-heading', ['label' => __('kindergarten.kindergartenManagerTh'),'key' => 'kindergarten_manager_id','width' => '9.4%'])
