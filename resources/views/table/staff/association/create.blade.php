    ...
    <div class="page-wrapper">
        <div class="page-content">
            <div class="page-breadcrumb d-flex align-items-center mb-3">
                ...
                <div class="ms-auto">
                    <div class="">
                        <a href="{{ route('staff-table.index') }}?type=association" class="btn button">{{ __('comon.back') }}</a>
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body p-4">
                            ...
                            <form class="row g-3" action="{{ route('staff-table.store') }}" method="POST">
                                @csrf
                                <div class="col-md-12">
                                    @include('components.text-input', ['label' => 'Association', 'name' => 'name', 'icon' => 'user-circle'])
                                </div>
                                <div class="col-md-12">
