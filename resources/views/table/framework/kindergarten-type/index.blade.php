<div class="mb-4 page-info">
    <div>
        <h3 class="mb-0 text-uppercase">{{ __('tables.kindergartenTypes') }}</h3>
    </div>
    <div class="mt-3">
        <a href="{{ route('framework-table.create') }}?type=kindergarten-type" class="btn button">{{ __('comon.addNew') }} +</a>
        <button class="btn button moveToArchive" data-type="kindergarten-type">{{ __('comon.moveToArchive') }}</button>
    </div>
</div>
