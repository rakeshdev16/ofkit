            ...
            <div class="page-wrapper">
                <div class="page-content">
                    <div class="page-breadcrumb d-flex align-items-center mb-3">
                        ...
                        <div class="ms-auto">
                            <div class="">
                                <button data-url="{{ route('framework-table.index') }}?type=framework-type" class="btn button exit">{{ __('comon.back') }}</button>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xl-6 mx-auto">
                            <div class="card">
                                <div class="card-body p-4">
                                    <h5 class="mb-4">{{ __('tables.addFrameworkDetail') }}</h5>
                                    <form class="row g-3" action="{{ route('framework-table.store') }}" method="POST">
                                        @csrf
                                        <div class="col-md-12">
                                            @include('components.text-input', ['label' => __('tables.frameworkType'), 'name' => 'name', 'icon' => 'user-circle'])
                                        </div>
                                        <div class="col-md-12">
