                ...
                <div class="col-xl-6 mx-auto">
                    <div class="card">
                        <div class="card-body p-4">
                            <h5 class="mb-4">{{ __('cluster.addClusterDetail') }}</h5>
                            <form class="row g-3" action="{{ route('cluster.store') }}" method="POST">
                                @csrf
                                <div class="col-md-6">
                                    @include('components.text-input', ['label' => __('cluster.clusterTh'), 'name' => 'cluster', 'icon' => 'network-chart'])
                                </div>
                                <div class="col-md-6">
