<tr>
    ...
    <td class="text-center">{{ $summary['individual']+$summary['group']+$summary['staff-meeting']+$summary['tutorial']+$summary['preparation']+$summary['documentation-break'] }}</td>
    ...
    <td class="text-center">{{ $summary['documentation-break'] }}</td>
</tr>