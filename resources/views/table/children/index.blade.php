        ...
        <div class="page-content">
            <div class="card-body">
                ...
                <div class="tab-content pt-3">
                    ...
                    <div class="tab-pane fade {{ request()->type == 'file-type' ? 'active show' : '' }}" id="file-type" role="tabpanel">
                        @if (request()->type == 'file-type')
                            @include('table.children.file-type.index', ['fileTypes' => $fileTypes])
                        @endif
                    </div>
                </div>
            </div>
