                        ...
                        <div class="ps-3">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0 p-0">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">{{ __('tables.association') }}</li>
                                </ol>
                            </nav>
                        </div>
                        <div class="ms-auto">
                        ...
                        <div class="col-xl-6 mx-auto">
                            <div class="card">
                                <div class="card-body p-4">
                                    <h5 class="mb-4">{{ __('tables.addAssociationDetail') }}</h5>
                                    <form class="row g-3" action="{{ route('staff-table.store') }}" method="POST">
                                        @csrf
                                        <div class="col-md-12">
                                            @include('components.text-input', ['label' => __('tables.association'), 'name' => 'name', 'icon' => 'user-circle'])
                                        </div>
                                        <div class="col-md-12">
