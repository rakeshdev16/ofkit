<div class="mb-4 page-info">
    <div>
        <h3 class="mb-0 text-uppercase">{{ __('tables.staffAcademicProfession') }}</h3>
    </div>
    <div class="mt-3">
        <a href="{{ route('staff-table.create') }}?type=profession" class="btn button">{{ __('comon.addNew') }} +</a>
        <button class="btn button moveToArchive" data-type="profession">{{ __('comon.moveToArchive') }}</button>
    </div>
</div>
