...
class ChildrenController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'father_telephone.regex' => 'The number must be a combination of digits and hyphens, and must be between 8 and 14 characters long.',
            'mother_telephone.regex' => 'The number must be a combination of digits and hyphens, and must be between 8 and 14 characters long.',
            'emergency_telephone.regex' => 'The number must be a combination of digits and hyphens, and must be between 8 and 14 characters long.',
    ...
    public function update(Request $request, $id)
    {
        $validator = Validator::make($request->all(), [
            ...
            'father_email' => ['nullable', 'string', 'email', 'max:255', Rule::unique('children_parents')->ignore($id)],
            'father_telephone' => ['nullable', 'regex:/^[0-9-]{8,14}$/'],
            'mother_email' => ['nullable', 'string', 'email', 'max:255', Rule::unique('children_parents')->ignore($id)],
            'mother_telephone' => ['nullable', 'regex:/^[0-9-]{8,14}$/'],
            'emergency_telephone' => ['nullable', 'regex:/^[0-9-]{8,14}$/'],
            'food_allergie_detail' => "required_if:food_allergie,==,yes",
            'medicine_dosage.*.name' => "required_if:medicine,==,yes",
